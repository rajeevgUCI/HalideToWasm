...
$(EMSCRIPTEN_OUT_JS): $(EMSCRIPTEN_SRC_CPP)
	...
	emcc $(EMSCRIPTEN_SRC_CPP) -std=c++11 -I $(HALIDE_LIB)/include/ -s EXPORTED_FUNCTIONS=$(EMSCRIPTEN_EXPORTED_FNS) -s EXTRA_EXPORTED_RUNTIME_METHODS=$(EMSCRIPTEN_EXTRA_EXPORTED_RUNTIME_METHODS) -o $(EMSCRIPTEN_OUT_JS) -s TOTAL_MEMORY=67108864
