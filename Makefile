...
EMSCRIPTEN_EXPORTED_FNS = '["_myfunc_cpp", "_create_halide_buffer", "_custom_halide_error_buffer_argument_is_null", "_custom_halide_error_bad_type", "_custom_halide_error_access_out_of_bounds", "_custom_halide_error_bad_dimensions", "_custom_halide_error_buffer_extents_negative", "_custom_halide_error_constraint_violated", "_custom_halide_error_buffer_allocation_too_large", "_custom_halide_error_buffer_extents_too_large", "_custom_halide_error_host_is_null", "_get_halide_buffer_data"]'
